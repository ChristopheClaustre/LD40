...
public class Animator_generateVictime : StateMachineBehaviour {
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.SetInteger("Chance", animator.gameObject.GetComponent<ONEPartieIManager>().CurrentRound.m_numberOfStrikes);
    }
